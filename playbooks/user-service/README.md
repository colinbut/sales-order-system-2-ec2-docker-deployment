...
This Ansible role deploys a containerized user-service microservice onto an EC2 instance within the Sales Order System 2.0 EC2 platform.
...
```bash
ansible-playbook -i inventory/hosts deploy_userservice.yml \
